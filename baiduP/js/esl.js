...
!function (n) {
    ...
    function t(n, e) {
        ...
        var a = P.waitSeconds;
        return a && n instanceof Array && ($ && clearTimeout($), $ = setTimeout(r, 1e3 * a)), H(n, e)
    }
    ...
    function a(n, e, t) {
        if (null == t && (null == e ? (t = n, n = null) : (t = e, e = null, n instanceof Array && (e = n, n = null))), null != t) {
            ...
            n ? u(n, e, t) : Q[0] = {deps: e, factory: t}
        }
    }
        ...
        if (e && !p(n, N)) {
            ...
            U(t, function (t, r) {
                ...
                s && !C[s] ? (c.res && (f = {
                    ...
                    absId: s,
                    hard: i > r
                }, e.depMs.push(u), e.depMkv[s] = u, a.push(s))) : u = {absId: s}, i > r && e.factoryDeps.push(f || u)
            }), e.state = N, l(n), m(a), o.length && e.require(o, function () {
        ...
        function t() {
            if (!r && i.state === z) {
                ...
                if (U(i.factoryDeps, function (n) {
                    ...
                    try {
                        var a = i.factory, o = "function" == typeof a ? a.apply(n, v(i.factoryDeps, {
                            require: i.require,
                            exports: i.exports,
                            module: i
                        })) : a;
                        null != o && (i.exports = o), i.invokeFactory = null
                    } catch (u) {
                        throw i.hang = 1, u
                    }
                    g(e)
    ...
    function y(e) {
        ...
        function r() {
            if (o) {
                var t;
                "function" == typeof o.init && (t = o.init.apply(n, v(u, C))), null == t && o.exports && (t = n, U(o.exports.split("."), function (n) {
                    return t = t[n], !!t
                })), a(e, u, function () {
                    return t || {}
                })
        ...
        if (!J[e] && !F[e]) {
            J[e] = 1;
            var o = P.shim[e];
            o instanceof Array && (P.shim[e] = o = {deps: o});
            var u = o && (o.deps || []);
            u ? (U(u, function (n) {
                P.shim[n] || (P.shim[n] = {})
            }), H(u, t)) : t()
    ...
    function b(n, e) {
        ...
        function r(r) {
            ...
            r.load(u.res, i, t, o.call({id: n}))
        }

        if (!F[n]) {
            var a = X[n];
            if (a) return void y(a);
            var u = j(n), f = {id: n, state: N};
    ...
    function k() {
        ...
        P.baseUrl = P.baseUrl.replace(/\/$/, "") + "/", K = x(P.paths), W = x(P.map, 1), U(W, function (n) {
            n.v = x(n.v)
        });
        var e = W[W.length - 1];
        ...
        var t = {}, r = P.packages.length;
        for (V = []; r--;) {
            var i, a = P.packages[r];
            switch (typeof a) {
                case"string":
                    i = {name: a.split("/")[0], location: a};
                    break;
                case"object":
                    i = {name: a.name, location: a.location, main: a.main}
            }
    ...
    function E(n, e) {
        var t = /(\.[a-z0-9]+)$/i, r = /(\?[^#]*)$/, i = "", a = n, o = "";
        r.test(n) && (o = RegExp.$1, n = n.replace(r, "")), t.test(n) && (i = RegExp.$1, a = n.replace(t, "")), null != e && (a = q(a, e));
        var u, f = a;
        return w(a, K, function (n, e) {
            f = f.replace(e, n), u = 1
        }), u || w(a, V, function (n, e, t) {
            f = f.replace(t.name, t.location)
        }), /^([a-z]{2,10}:\/)?\//i.test(f) || (f = P.baseUrl + f), f += i + o, w(a, Y, function (n) {
            f += (f.indexOf("?") > 0 ? "&" : "?") + n
        }), f
    }
    ...
    function A(n) {
        function t(t, i) {
            ...
            if (t instanceof Array) {
                var o = [], u = [];
                U(t, function (t, r) {
                    var i = j(t), a = q(i.mod, n), f = i.res, c = a;
                    if (f) {
                        var s = a + "!" + f;
    ...
    function R() {
        ...
        for (var n = document.getElementsByTagName("script"), e = n.length; e--;) {
            var t = n[e];
            if ("interactive" === t.readyState) return nn = t, t
        }
    }
    ...
    function D(n, e) {
        ...
        r.setAttribute("data-require-id", n), r.src = E(n + ".js"), r.async = !0, r.readyState ? r.onreadystatechange = t : r.onload = t, Z = r, tn ? en.insertBefore(r, tn) : en.appendChild(r), Z = null
    }

    var $, F = {}, B = 1, N = 2, z = 3, L = 4, _ = {}, C = {require: t, exports: 1, module: 1}, H = A(), P = {
        baseUrl: "./",
        paths: {},
        config: {},
        map: {},
    ...
    t.version = "2.1.6", t.loader = "esl", t.toUrl = H.toUrl;
    var Q = [];
    a.amd = {};
    var G = {}, J = {};
    t.config = function (n) {
        if (n) {
            for (var e in P) {
                var t = n[e], r = P[e];
                if (t) if ("urlArgs" === e && "string" == typeof t) P.urlArgs["*"] = t; else if (r instanceof Array) r.push.apply(r, t); else if ("object" == typeof r) for (var i in t) r[i] = t[i]; else P[e] = t
            }
            k()
        }
    }, k();
    var K, V, W, X, Y, Z, nn, en = document.getElementsByTagName("head")[0],
        tn = document.getElementsByTagName("base")[0];
    tn && (en = tn.parentNode), define || (define = a, require || (require = t), esl = t);
    var rn;
    !function () {
        for (var n = document.getElementsByTagName("script"), e = n.length; e--;) {
            var t = n[e];
